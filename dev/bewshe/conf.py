...
BLOG_AUTHOR = "timothy leffel"  # (translatable)
BLOG_TITLE = "bewshpage"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://lefft.xyz/dev/bewshe/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://lefft.xyz/dev/bewshe/"
BLOG_EMAIL = "tjleffel@gmail.com"
BLOG_DESCRIPTION = "first draft of homepage"  # (translatable)
